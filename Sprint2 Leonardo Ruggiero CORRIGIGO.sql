...
SELECT c.company_id 
FROM company c 
WHERE c.id = t.company_id AND c.country = 'Germany' AND t.declined = 0);
...
SELECT id 
FROM transaction t 
WHERE t.company_id = c.id AND t.declined = 1);
...
ALTER TABLE credit_card 
CHANGE COLUMN expiring_date_new expiring_date DATE;
...
LOAD DATA INFILE '/Users/leonardoruggiero/Documents/Curso Especializaçao 2026 SQL/N1-Ex.8__ american_users.csv' 
INTO TABLE user FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n' IGNORE 1 ROWS;

LOAD DATA INFILE '/Users/leonardoruggiero/Documents/Curso Especializaçao 2026 SQL/N1.Ex.8__ european_users.csv'
INTO TABLE user FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n' IGNORE 1 ROWS;

LOAD DATA INFILE '/Users/leonardoruggiero/Documents/Curso Especializaçao 2026 SQL/N1.Ex.8__ companies.csv'	
INTO TABLE company FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n' IGNORE 1 ROWS;

LOAD DATA INFILE '/Users/leonardoruggiero/Documents/Curso Especializaçao 2026 SQL/N1.Ex.8__ credit_cards.csv'
...
LOAD DATA INFILE '/Users/leonardoruggiero/Documents/Curso Especializaçao 2026 SQL/N1.Ex.8__ transactions.csv'
INTO TABLE transaction FIELDS TERMINATED BY ';' ENCLOSED BY '"' LINES TERMINATED BY '\n' IGNORE 1 ROWS;
...
SELECT AVG(AMOUNT) AS media_amount, company_name, iban
FROM transaction
